...
export default class Chair extends Furnishing {
  ...
  constructor(furnishing,colors,brighten = false) {
    ...
    const material = new THREE.MeshPhongMaterial({ /*bumpMap: THREE.ImageUtils.loadTexture("dirt2.png",{},()=>{}), */ color: new THREE.Color(this.red/255,this.green/255,this.blue/255)});
    var scale = 1.5*0.6;
